...
export class Game {
    ...
    constructor(private _viewer:GameViewer){
        ...
        this._nextTeris = createTeris({x:0,y:0});//没有实际含义，只是为了不让ts报错
        this.createNext();
    ...
    private createNext() {
        ...
        this.resetCenterPoint(GameConfig.nextSize.with,this._nextTeris);
    ...
    private switchTeris(){
        ...
        this.resetCenterPoint(GameConfig.panelSize.with,this._curTeris);
        //有可能出现问题：当前方块一出现时，就已经和之前的方块重叠了
